  ...
  return (
    <div className="my-2 grid grid-flow-col grid-cols-4 grid-rows-4 gap-3 ">
      ...
      <div className="grid w-full max-w-sm items-center gap-1.5">
        ...
        <Input onChange={e=>handleIputChangeSuiviAgenda("nb_ech",e.target.value)} id="Nombreech" value={suiviAgenda.nb_ech} type="number" />
      </div>
      <div className="grid w-full max-w-sm items-center gap-1.5">
        <Label htmlFor="Montant1ere">Montant 1ére éch</Label>
        <Input onChange={e=>handleIputChangeSuiviAgenda("mntech1",e.target.value)}   value={suiviAgenda.mntech1} id="Montant1ere" type="text" />
      </div>
      <div className="grid w-full max-w-sm items-center gap-1.5">
        <Label htmlFor="Montant2ere">Montant 2ére éch</Label>
        <Input onChange={e=>handleIputChangeSuiviAgenda("mntech2",e.target.value)}   value={suiviAgenda.mntech2} id="Montant2ere" type="text" />
      </div>
      ...
      <div className="grid w-full max-w-sm items-center gap-1.5">
        ...
        <Input onChange={e=>handleIputChangeSuiviAgenda("mntech3",e.target.value)} value={suiviAgenda.mntech3} id="Montant3ere" type="text" />
      </div>
      <div className="grid w-full max-w-sm items-center gap-1.5">
        <Label htmlFor="Montant4ere">Montant 4ére éch</Label>
        <Input  onChange={e=>handleIputChangeSuiviAgenda("mntech4",e.target.value)}  value={suiviAgenda.mntech4} id="Montant4ere" type="text" />
      </div>
      <div className="grid w-full max-w-sm items-center gap-1.5">
        <Label htmlFor="Montant5ere">Montant 5ére éch</Label>
        <Input onChange={e=>handleIputChangeSuiviAgenda("mntech5",e.target.value)}  value={suiviAgenda.mntech5} id="Montant5ere" type="text" />
      </div>
