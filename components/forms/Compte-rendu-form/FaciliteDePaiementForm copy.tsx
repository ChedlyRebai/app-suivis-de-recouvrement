  ...
  return (
    <div className="my-2 grid grid-flow-col grid-cols-4 grid-rows-4 gap-3 ">
      ...
      <div className="grid w-full max-w-sm items-center gap-1.5">
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">{suiviAgenda.nb_ech!! > 0 && (<>
      ...
      <div className="grid w-full max-w-sm items-center gap-1.5"></div>
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">{suiviAgenda.nb_ech!! >= 1 && (<>
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">{suiviAgenda.nb_ech!! >= 2 && (<>
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">{suiviAgenda.nb_ech!! >= 3 && (
        <>
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">{suiviAgenda.nb_ech!! >= 4 && (<>
      ...
      <div className="grid   items-center gap-1.5 col-span-2">
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">{suiviAgenda.nb_ech!! >= 5 && (<>
