...
export default async function page() {
  const comptes = await getCompteByClientId(1);
  const compterendus = await getCompteRenduByClientId(1);
  const documents = await getAllfilesByClientId(1);
  console.log(comptes, compterendus);
  return (
